...
const Navbar = () => {
  ...
  return (
    <div className="mx-4 mt-4 z-50 bg-black/20 backdrop-blur-lg shadow-lg border-b border-gray-300 rounded-lg">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="absolute top-full left-0 w-full bg-white shadow-lg rounded-lg p-6 flex flex-col gap-4 md:hidden"
